...
# perform inference
inference = VERSO(D=D,lik_w=1,alpha=alpha,beta=beta,keep_equivalent=TRUE,check_indistinguishable=TRUE,num_rs=500,num_iter=100000,n_try_bs=5000,marginalize=FALSE,num_processes=16,seed=22222,verbose=TRUE)
