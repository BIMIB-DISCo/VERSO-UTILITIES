...
#' Compute mutation distance from VERSO corrected genotype.
...
#'
#' @param inference Results of the inference by VERSO.
#' @return A matrix mutation_distance with the mutation distance computed from VERSO corrected genotype.
